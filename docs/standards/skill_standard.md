...
> Estrutura padrão para as Skills (funções que o agente pode executar) desta plataforma. Define o formato; a lista de skills deste agente fica em `../agent/skills.md` e a implementação em `../../src/aqua_qe_solution_architect/skills/`.
...
- Cada skill vive em seu próprio arquivo, com uma função pública por arquivo (ver `src/aqua_qe_solution_architect/skills/`).
